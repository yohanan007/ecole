 ...
 */
final class Version20250817180517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agenda (id INT AUTO_INCREMENT NOT NULL, heureDebut DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE classe_eleve (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, eleve_id INT DEFAULT NULL, date_valide DATETIME DEFAULT NULL, date_fin DATETIME DEFAULT NULL, INDEX IDX_A5D651CF8F5EA509 (classe_id), INDEX IDX_A5D651CFA6CC7B2 (eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE eleve (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, eleve_matiere_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_ECA105F7A76ED395 (user_id), INDEX IDX_ECA105F7F6563D0A (eleve_matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, agenda_id INT NOT NULL, sujet VARCHAR(255) DEFAULT NULL, corps LONGTEXT DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, duree INT DEFAULT NULL, recurrence VARCHAR(50) DEFAULT NULL, INDEX IDX_B26681EEA67784A (agenda_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE parent_eleve (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, code_postal VARCHAR(255) NOT NULL, pays VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_20909154A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
